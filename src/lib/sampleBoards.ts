  ...
  return {
    ...
    golfLog: {
      rounds: [
        {
          id: "ex-golf-rd",
          date: yday,
          course: "Executive 9 I swore was a walk in the park",
          holes: 9,
      ...
      looking: [
        {
          id: "ex-golf-look",
          text: "Need a fourth who pretends not to notice my mulligan policy",
          extra: "Mornings · executive 9 · no sandbaggers, we already have me",
        },
      ],
    },
    pickleballLog: {
      ...
      looking: [
        {
          id: "ex-pb-look",
          text: "Beginner-friendly until game three, then it’s a documentary",
          extra: "Rohan mornings · bring water and plausible deniability",
        },
      ],
    },
