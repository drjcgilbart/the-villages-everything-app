...
export const AREA_SERVICE_ART: Record<AreaServiceCategory, string> = {
  ...
  "Hair Salons": "/graphics/local-pros/hair-salons.jpg",
  "Nail Salons": "/graphics/local-pros/nail-salons.jpg",
  Barbers: "/graphics/local-pros/barbers.jpg",
  "Spas & Massage": "/graphics/local-pros/spas-massage.jpg",
  "Pet Grooming": "/graphics/local-pros/pet-grooming.jpg",
  Veterinarians: "/graphics/local-pros/veterinarians.jpg",
  "Dog Walkers": "/graphics/local-pros/dog-walkers.jpg",
  "Pet Sitting": "/graphics/local-pros/pet-sitting.jpg",
  "House Sitting": "/graphics/local-pros/house-sitting.jpg",
  "Home Watch": "/graphics/local-pros/home-watch.jpg",
