...
export function AdminLocalServicesPanel() {
  ...
  const [edit, setEdit] = useState<Partial<LocalServiceListing>>({});
  ...
  return (
    <div>
      <p style={{ color: "var(--muted)", marginTop: 0 }}>
        ...
        public form replace the live listing when you approve them.
      </p>
                ...
                <div className="form-grid" style={{ marginTop: "0.75rem" }}>
                  ...
                  <div className="field">
                    ...
                    <input
                      value={edit.village || ""}
                      onChange={(e) =>
                        setEdit((p) => ({ ...p, village: e.target.value }))
                      }
                    />
                  </div>
                  ...
                  <div className="field">
                    ...
                    <input
                      value={edit.website || ""}
                      onChange={(e) =>
                        setEdit((p) => ({ ...p, website: e.target.value }))
                      }
                    />
                  </div>
                  <div className="field">
                    ...
                    <input
                      value={edit.photoUrl || ""}
                      onChange={(e) =>
                        setEdit((p) => ({ ...p, photoUrl: e.target.value }))
                      }
                    />
                  </div>
                  <div className="field field-full">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEdit((p) => ({ ...p, adminNote: e.target.value }))
                      }
                    />
                  </div>
