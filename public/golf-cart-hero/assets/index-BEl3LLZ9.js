...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function qg(i,e,t){const n=new Float32Array(zi),s=new D(0,1,0);return new Ln({name:"SphericalGaussianBlur",defines:{n:zi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Sh(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function bh(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oa(),fragmentShader:`
...
#define LOW_PRECISION`),e}const cx={[aa]:"SHADOWMAP_TYPE_PCF",[Js]:"SHADOWMAP_TYPE_VSM"};function lx(i){return cx[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const hx={[Wi]:"ENVMAP_TYPE_CUBE",[Ts]:"ENVMAP_TYPE_CUBE",[Ia]:"ENVMAP_TYPE_CUBE_UV"};function dx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":hx[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const ux={[Ts]:"ENVMAP_MODE_REFRACTION"};function fx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":ux[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const px={[md]:"ENVMAP_BLENDING_MULTIPLY",[rf]:"ENVMAP_BLENDING_MIX",[af]:"ENVMAP_BLENDING_ADD"};function mx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":px[i.combine]||"ENVMAP_BLENDING_NONE"}function gx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function _x(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=lx(t),l=dx(t),h=fx(t),d=mx(t),u=gx(t),f=ex(t),g=tx(r),_=s.createProgram();let m,p,y=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Qs).join(`
`)),a=Tc(a),a=Dh(a,t),a=Nh(a,t),o=Tc(o),o=Dh(o,t),o=Nh(o,t),a=Uh(a),o=Uh(o),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
void main() {
      ...
      <div class="screen panel-host">
        ...
        <div class="panel">
          ...
          <div class="btn-row">
            ...
            <button class="btn-gold" id="btn-lb">${Ks()}</button>
            ${er()?"":'<button class="btn-sunset" id="btn-donate">Tip the Dev ⛳</button>'}
          </div>
          <div class="help-keys">
        ...
        ${er()?"":`<div class="panel tight donate-teaser" id="menu-donate">
        ...
        <div class="panel tight" id="menu-lb">
          <h2 style="font-size:1.15rem">🏆 ${Ks()}</h2>
          <p style="margin:0.35rem 0 0;color:var(--muted);font-size:0.88rem">${ki.leaderboardTag}</p>
    ...
    `;const r=this.root.querySelector("#donate-amounts");r.innerHTML=il.map(c=>`
      ...
      <div class="screen">
        ...
        <h1>🏆 ${Ks()}</h1>
        <p class="tagline">${ki.leaderboardTag}</p>
        <div class="panel">
    ...
    `,this.root.querySelector("#btn-back").addEventListener("click",()=>this.handlers.onBackMenu())}renderLeaderboardList(e){return e.length?`<ol class="leaderboard">${e.map((t,n)=>{const s=Cs.find(o=>o.id===t.cartId)?.shortName??t.cartId,r=Ps.find(o=>o.id===t.driverId),a=r?ma(r):"🏎️";return`<li>
          <span class="rank">#${n+1}</span>
          <div class="who">${cn(t.playerName)} ${a}
      ...
      <div class="screen">
        ...
        <div class="panel" style="max-width:640px">
          ...
          <p><strong>Score:</strong> Speed + landmark bonuses − hazard penalties + finish place. Top runs land on the <em>${Ks()}</em> board.</p>
          ${er()?"":"<p><strong>Tips:</strong> From the main menu, tip $1 / $3 / $5 via Stripe. Your highest tip paints a supporter flag on every cart you race — red, blue, or gold — with the golf-ball mascot logo.</p>"}
    ...
    `;const t=this.root.querySelector("#areas"),n={"spanish-springs":"Original plaza","lake-sumter":"Lake & lighthouse",brownwood:"Old Florida ranch",eastport:"East-side hub","sawgrass-grove":"Grove & market"};t.innerHTML=Ss.map(s=>`
      ...
      <div class="screen screen-garage">
        ...
        <div class="panel garage-panel">
          <div class="area-picked">
            ...
            <div>
              <strong>${cn(e.name)}</strong>
              <div class="sub" style="margin:0">${cn(e.themeLine)}</div>
            </div>
    ...
    `;const t=this.root.querySelector("#difficulties");t.innerHTML=Ca.map(o=>`
      <button type="button" class="choice-card ${o.id===this.select.difficultyId?"selected":""}" data-diff="${o.id}">
        ...
        <div class="title">${cn(o.name)}</div>
        <div class="sub">${cn(o.blurb)}</div>
      </button>`).join("");const n=this.root.querySelector("#carts");n.innerHTML=Cs.map(o=>`
      ...
      </button>`).join("");const s=this.root.querySelector("#drivers");s.innerHTML=Ps.map(o=>`
